...
def plot_data(input_dir, output_dir):
    input_files = glob.glob(f"{input_dir}/res_*.csv");
    ...
    for file in input_files:
        ...
        plt.savefig(f"{output_dir}/{name}.pdf", format='pdf')
...
if __name__ == "__main__":
    ...
    plot_data(input_dir, output_dir)